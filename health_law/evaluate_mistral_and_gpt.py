...
# pathname = "health_law/datasets/results/mistral_and_gpt_models_merged.csv"
pathname = "health_law/datasets/results/mistral_and_gpt_models_and_claude_haiku_merged.csv"
...
# save to CSV
melted_df.to_csv('health_law/datasets/melted_df_for_mixed_model_mistral_and_gpt_and_claude.csv')

# output summary
# summary = analysis.analyse_health_law('health_law/datasets/melted_df_for_mixed_model.csv')
summary = analysis.analyse_health_law('health_law/datasets/melted_df_for_mixed_model_mistral_and_gpt_and_claude.csv')

# variation = analysis.check_question_variation('health_law/datasets/melted_df_for_mixed_model.csv')
variation = analysis.check_question_variation('health_law/datasets/melted_df_for_mixed_model_mistral_and_gpt_and_claude.csv')
